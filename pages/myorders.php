...
/*navigation bar start*/
 ...
 /*navigation bar end*/         
  ?>
        ...
        <div>
        <div id="my-orders-con">
              <div  id="my-orders-con1" >
               <h3 id="my-oders-header">current orders</h3><br>
               <h4 id="my-oders-header1">no available orders</h4>
               </div>
              
              <div  id="my-orders-con2">
               <h3 id="my-oders-header">Recent orders</h3><br>
               <h4 id="my-oders-header1">no available orders</h4>
                <div>
        </div>
       </div>
