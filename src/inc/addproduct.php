...
if (isset($_POST['add-product-btn'])) {
    ...
    $sql = "INSERT INTO product(product_name,product_img_path,product_price,product_quantity,product_color,product_size) VALUES ('{$product_name}','{$file}','{$product_price}','{$product_quantity}','{$product_color}','{$product_size}')";
